...
"""
We need to export the following environemt variables in our Terminal from spotify developer ->create app
    set SPOTIPY_CLIENT_ID='your-spotify-client-id' (e.g. 709d1bd12be34fb6b76aacf9a21e1494)
    set SPOTIPY_CLIENT_SECRET='your-spotify-client-secret' (e.g. b9f2c793bfcf4fa59a20f466335d17a4)
    set SPOTIPY_REDIRECT_URI='your-app-redirect-url' (http://localhost:8080 for testing)
"""

# create the spotipy instance with the read and write scope
# set a fixed username for now
# user name from spotify account
username = "i1cgb6pj11jfypb1n5yy9laa2"
